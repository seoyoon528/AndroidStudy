...
class HouseListAdapter: ListAdapter<HouseModel, HouseListAdapter.ItemViewHolder>(differ) {
    ...
    inner class ItemViewHolder(val view: View): RecyclerView.ViewHolder(view) {
        ...
        fun bind (houseModel: HouseModel) {
            ...
            Glide
                ...
                .transform(CenterCrop(), RoundedCorners(dptoPx(thumbnailImageView.context, 12)))        //  이미지 다듬기
                .into(thumbnailImageView)
        }
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HouseListAdapter.ItemViewHolder {
    ...
    private fun dptoPx(context: Context, dp: Int): Int {        //  dp -> pixel 변환
